      ...
      >
        <Slide transition={['slide']} bgColor="black">
          <Notes>
            ...
            <br />
            <br />
            <p>How many of you use CSS in your work?</p>
          </Notes>
        ...
        <Slide transition={['slide']} bgColor="primary">
          <Notes>
            ...
            <br />
            <br />
            my name is Joonas Kallunki,
            <br />
            <br />
            I’m frontend developer at Gofore,
            <br />
            <br />
            and i’m here to talk about CSS
            <br />
            <br />
            <br />
            <br />
            These features I'm going to talk about are bit complex
            <br />
          ...
          <Notes>
            ...
            <ul>
              ...
              <li style={{ marginTop: '1em' }}>
                And environment variable -function has landed to Safari
                <br />
        ...
        <Slide>
          <Notes>Here are some rules</Notes>
          <Heading fit margin="-1em 0 0 0">
        ...
        <Slide {...utils.secondarySlide}>
          <Notes>and here's the CSS.</Notes>
          <Layout>
            <div style={{ margin: '-10px 0.5rem 0 0' }}>
              <Image width="440px" src={css.images.filters1} />
            </div>
        ...
        <Slide>
          <Notes>
            ...
            <br />
            <br />
            They are bringing the API's to browser's CSS engines
          </Notes>
        ...
        <Slide {...utils.secondarySlide}>
          <Notes>
            THANK YOU
            <br />
            Let's continue from here, you can find me on twitter @jkallunki
            <br />
            <br />
            <br />
